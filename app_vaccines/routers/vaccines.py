...
def get_vaccines(vaccine_id: int):
    ...
    return HTTPException(status_code=404, detail="Данные о вакцинации не найдены")
...
def delete_vaccines(vaccine_id: int, vaccine: Vaccine):
    for idx, vaccine in enumerate(fake_database):
        if vaccine["id"] == vaccine_id:
